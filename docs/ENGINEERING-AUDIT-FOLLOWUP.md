...
| DATA-02 — campaign “sync” created duplicate rows | **Contained, not complete** | The unsafe calls were removed. Campaigns are explicitly local-only; real synchronization remains a planned feature. |
