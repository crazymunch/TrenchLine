...
const out = `import { Faction, UnitProfile, WeaponProfile, ArmourProfile, EquipmentItem, RuleKeyword, InjuryResult, Scenario } from '../types/rules';

export const FACTIONS: Faction[] = ${JSON.stringify(FACTIONS, null, 2)};

export const BASE_UNITS: UnitProfile[] = ${JSON.stringify(BASE_UNITS, null, 2)};

export const BASE_WEAPONS: WeaponProfile[] = ${JSON.stringify(BASE_WEAPONS, null, 2)};

export const BASE_ARMOUR: ArmourProfile[] = ${JSON.stringify(BASE_ARMOUR, null, 2)};

export const BASE_EQUIPMENT: EquipmentItem[] = ${JSON.stringify(BASE_EQUIPMENT, null, 2)};

export const KEYWORDS: RuleKeyword[] = ${JSON.stringify(KEYWORDS, null, 2)};

export const INJURY_TABLE_D66: InjuryResult[] = ${JSON.stringify(INJURY_TABLE_D66, null, 2)};

export const EXPLORATION_TABLE_D66 = ${JSON.stringify(EXPLORATION_TABLE_D66, null, 2)};

export const SCENARIOS: Scenario[] = ${JSON.stringify(SCENARIOS, null, 2)};
`;

fs.writeFileSync('src/data/defaultRules.ts', out);
console.log('Successfully generated clean src/data/defaultRules.ts');
