...
const rulesContent = `import { Faction, UnitProfile, WeaponProfile, ArmourProfile, EquipmentItem, RuleKeyword, Scenario } from '../types/rules';
...
fs.writeFileSync('src/data/defaultRules.ts', rulesContent, 'utf8');
console.log('Successfully generated repo-aligned src/data/defaultRules.ts');
