...
export const TRENCH_COMPANION_IDS: {
  ...
  "_shape": "Keys are their object_id exactly. `ours` is the name in our dataset, or null where there is none. `theirs` is the name THEIR bundle gives it. `why` says what no slug rule can reach.",
  ...
  "ids": {
    ...
    "el_snipersnest": {
      "ours": "Sniper’s Lair",
      "theirs": "Sniper's Nest",
      "why": "Their id is a slug of 'Sniper's Nest' and our Common Locations table prints 'Sniper’s Lair' — the same Location, roll 16, and their bundle carries that Location's own text. It cannot be resolved by a wider name search either: the book DOES print a 'Sniper's Nest', at extract line 6259, but as a Ranged Skill. A Location resolves only against the Location table, so a name that reaches the Skill would be the wrong kind of thing entirely.",
      "cites": "Trench Companion bundle, location el_snipersnest, carrying the text of the Common Locations roll-16 result. Ours: rulebook extract line 6821, Common Locations, 'Sniper’s Lair'. The unrelated Ranged Skill 'Sniper's Nest' is extract line 6259."
    }
  }
};
